...
exports.TradesmanServicesService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const ServiceDto_1 = require("../dto/ServiceDto");
const Service_1 = require("../entity/Service");
const typeorm_2 = require("typeorm");
let TradesmanServicesService = class TradesmanServicesService {
    constructor(servicesRepositry) {
        this.servicesRepositry = servicesRepositry;
    }
    ;
    mapServiceToDto(service) {
        const serviceDto = new ServiceDto_1.ServiceDto();
    ...
    async create(serviceDto) {
        ...
        const capitalziedObject = this.capitalizeObjectValuesExceptEmail(serviceDto);
        return this.servicesRepositry.save(capitalziedObject);
    }
    capitalizeObjectValues(obj) {
    ...
    capitalizeObjectValuesExceptEmail(obj) {
        Object.keys(obj).forEach((key) => {
...
exports.TradesmanServicesService = TradesmanServicesService;
exports.TradesmanServicesService = TradesmanServicesService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(Service_1.Service)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], TradesmanServicesService);
//# sourceMappingURL=tradesman-services.service.js.map